<?php include 'header.php'; ?>
    <main class="page-room-1">

        <div class="hero full-height jarallax" data-jarallax data-speed="0.2">
            <img class="jarallax-img kenburns" src="img/rooms/Sunflower/DSC_2178.jpg" alt="">
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            ...
                            <h1 class="slide-animated two">Sunflower Suite</h1>
                            <small>First Floor</small>
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-lg-6">
                        <div class="room_facilities_list">
                            ...
                            <li class="ic"><img src="img/sofa.png" class="small">Sofa</li>
                                ...
                                <li class="ic"><img src="img/kettle.png" class="small">Tea Kettle</li>
                                <li><i class="icon-hotel-bottle"></i>Complementary Water Bottle</li>
                                <li class="ic"><img src="img/breakfast.png" class="small">Complementary BreakFast</li>
                                <li><i class="icon-hotel-loundry"></i>Loundry Service</li>
                                <li><i class="icon-hotel-dog"></i> Pet Allowed</li>
                                <li class="ic"><img src="img/friendship.png" class="small">Couple Friendly</li>
                                <li class="ic"><img src="img/cake.png" class="small">4 Guests</li>
            ...
            <div class="container-fluid p-lg-0">
                <div data-cues="zoomIn">
                    <div class="owl-carousel owl-theme carousel_item_centered kenburns rounded-img">
                        <div class="item">
                            <img src="img/rooms/Sunflower/DSC_2178.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="img/rooms/Sunflower/DSC_2180.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="img/rooms/Sunflower/DSC_2181.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="img/rooms/Sunflower/DSC_2182.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="img/rooms/Sunflower/DSC_2184.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="img/rooms/Sunflower/DSC_2187.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="img/rooms/Sunflower/DSC_2191.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="img/rooms/Sunflower/DSC_2192.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="img/rooms/Sunflower/DSC_2197.jpg" alt="">
                        </div>
                    </div>
                </div>
        ...
        <div class="bg_white">
            <div class="container margin_30_30">
                <div data-cue="slideInUp">
                    <div class="title">
                        <small>Hotel Five Elements</small>
                        <h2>Similar Rooms</h2>
                    </div>
