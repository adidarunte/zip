    ...
    <main class="page-room-1">
        ...
        <div class="hero full-height jarallax" data-jarallax data-speed="0.2">
            <img class="jarallax-img kenburns" src="img/rooms/Tulip/DSC_2151.jpg" alt="">
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            ...
                            <h1 class="slide-animated two">Tulip Suite</h1>
                    ...
                    <div class="col-lg-6">
                        <div class="room_facilities_list">
                            ...
                            <li class="ic"><img src="img/sofa.png" class="small">Sofa</li>
                                ...
                                <li class="ic"><img src="img/cake.png" class="small">3 Guests</li>
            ...
            <div class="container-fluid p-lg-0">
                <div data-cues="zoomIn">
                    <div class="owl-carousel owl-theme carousel_item_centered kenburns rounded-img">
                        <div class="item">
                            <img src="img/rooms/Tulip/DSC_2151.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="img/rooms/Tulip/DSC_2154.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="img/rooms/Tulip/DSC_2156.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="img/rooms/Tulip/DSC_2164.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="img/rooms/Tulip/DSC_2167.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="img/rooms/Tulip/DSC_2172.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="img/rooms/Tulip/DSC_2174.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="img/rooms/Tulip/DSC_2175.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="img/rooms/Tulip/DSC_2146.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="img/rooms/Tulip/DSC_2417.jpg" alt="">
                        </div>
                    </div>
                </div>
