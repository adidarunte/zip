<?php include 'header.php'; ?>
    <main class="page-room-3">

        <div class="hero full-height jarallax" data-jarallax data-speed="0.2">
            <img class="jarallax-img kenburns" src="img/gallery/DSC_2184.jpg" alt="">
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            ...
                            <h1 class="slide-animated two">Lilly Standard</h1>
                    ...
                    <div class="col-lg-6">
                        <div class="room_facilities_list">
                            <ul data-cues="slideInLeft">
                                ...
                                <li class="ic"><img src="img/cake.png" class="small">2 Guests</li>
