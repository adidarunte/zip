...
<?php include 'header.php'; ?> 
    <main class="page-about-us">
      <div class="hero small-height jarallax" data-jarallax data-speed="0.2">
          <img class="jarallax-img" src="img\OUTDOOR EXCLUSIVE NIGHT VIEW\BANNER 1.jpg" alt="">
          ...
          <div class="row justify-content-between align-items-center">
              <div class="col-lg-5">
                  <div class="parallax_wrapper inverted">
                      <img src="img/gallery/IMG-20180920-WA0004.jpg" alt="" class="img-fluid rounded-img">
                      <div data-cue="slideInUp" class="img_over"><span data-jarallax-element="-30"><img src="img/gallery/DSC_2472.jpg" alt="" class="rounded-img"></span></div>
                  </div>
              </div>
              <div class="col-lg-5">
                  <div class="intro">
                  ...
                  <div class="row justify-content-between">
                      <div class="col-lg-5 fixed_title">
                          ...
                          <div class="list_ok">
                              <ul>
                                  ...
                                  <li data-cue="slideInUp" data-delay="400">
                                      <h5>Places to visit in Lonavala </h5>
                                      <p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit.</p>
                                  </li>
                              </ul>
                          </div>
                      ...
                      <div class="col-lg-6 ">
                          <div data-cue="fadeIn" data-delay="500">
                              <figure><img src="img/gallery/DSC_2433.jpg" alt="" class="img-fluid rounded-img"></figure>
                          </div>
                          <div data-cue="fadeIn" data-delay="500">
                              <figure>
                                  <img src="img/gallery/DSC_2407.jpg" alt="" class="img-fluid rounded-img">
                              </figure>
                          </div>
                          <div data-cue="fadeIn" data-delay="500">
                              <figure>
                                  <img src="img/gallery/DSC_2438.jpg" alt="" class="img-fluid rounded-img">
                              </figure>
                          </div>
                      </div>
                  </div>
      ...
      <div class="parallax_section_1 jarallax" data-jarallax data-speed="0.2">
                                ...
                                <div>
                                    <div class="box_overlay">
                                        <div class="pic">
                                            ...
                                            <h4>Sandip<small>2 Nov</small></h4>
                                        </div>
                                        <div class="comment">
                                            "Comfortable and cozy stay ...Location was good ..staff and service was excellent"
                                        </div>
                                    </div>
                                    <!-- End box_overlay -->
                                </div>
                                <div>
                                    <div class="box_overlay">
                                        <div class="pic">
                                            ...
                                            <h4>Tanaya<small>3 Dec</small></h4>
                                        </div>
                                        <div class="comment">
                                            "Really well maintained premises with budget friendly rooms. Friendly services and lovely food. Had a great time."
                                        </div>
                                    </div>
                                    <!-- End box_overlay -->
                                </div>
        ...
        <!-- /parallax_section_1-->
          ...
          <div class="container margin_120_95">
              <div class="col-lg-8">
                  <div class="title">
                      <small>Hotel Five Elements Faq</small>
                      <h3>Frequently Questions</h3>
                  </div>
                  <p>Can’t find your question in the list?
                      Let us know your questions.</p>
                  <p><a href="contact-us" class="animated_link"><strong>Contact Us <i class="bi bi-arrow-right"></i></strong></a></p>
              </div>
